...
export const TABLE_COLS = ["상품명", "카테고리", "노출수", "클릭수", "광고비", "주문금액", "상품주문수", "반품건수", "ROAS"];
export const REFERENCE_ONLY_COLS = ["ROAS"];
export const REQUIRED_COLS = ["상품ID", "상품명", "노출수", "클릭수", "광고비", "주문금액", "상품금액", "상품 상세 방문수", "장바구니 유저수", "찜 유저수", "상품주문수", "반품건수", "판매 사이트"];
